...
import {
    Button, Container, Box, RadioGroup, Radio, HStack, VStack, Text,
    Image, Stat, StatLabel, StatNumber, StatHelpText, StatArrow, Badge, Progress
...
const CoinDetails = () => {
    ...
    const switchChartStats = (dateFormatKey) => {
